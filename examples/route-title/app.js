...
const About = { template: '<div><h2>About</h2><router-view></router-view></div>' }
const Child = { template: '<div><h2>Child</h2></div>' }
...
const router = new VueRouter({
  ...
  routes: [
    ...
    { path: '/about/:id', title: 'about', name: 'about', component: About,
      children: [
        { path: 'child', title: 'child', component: Child }
      ]
    }
  ]
})
  ...
  template: `
    <div id="app">
      ...
      <ul>
        ...
        <li><router-link to="/about/1/child">Link To /about/1/child</router-link></li>
        ...
        <li><a @click="push('/about/1/child')" >Push To /about/1/child</a></li>
        ...
        <li><a @click="replace('/about/1/child')" >Replace To /about/1/child</a></li>
