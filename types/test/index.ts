...
import VueRouter, { Route, RouteRecord, RedirectOption } from "../index";
...
const Functional = { functional: true, template: "<div>functional</div>" };
...
const Components: Component[] = router.getMatchedComponents();
